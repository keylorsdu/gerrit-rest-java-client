...
public class AccountsRestClientTest {
    ...
    public void testStarChange() throws Exception {
        GerritRestClient gerritRestClient =
            gerritRestClientExpectPut("/accounts/jdoe/starred.changes/Iccf90a8284f8371a211db9a2824d0617e95a79f9");
        AccountsRestClient accountsRestClient =
            new AccountsRestClient(gerritRestClient, EasyMock.createMock(AccountsParser.class));
    ...
    public void testUnStarChange() throws Exception {
        GerritRestClient gerritRestClient =
            gerritRestClientExpectDelete("/accounts/jdoe/starred.changes/Iccf90a8284f8371a211db9a2824d0617e95a79f9");
        AccountsRestClient accountsRestClient =
            new AccountsRestClient(gerritRestClient, EasyMock.createMock(AccountsParser.class));
    ...
    public void testSuggestAccount() throws Exception {
        GerritRestClient gerritRestClient = gerritRestClientExpectGet("/accounts/?suggest&q=jdoe&n=5");
        AccountsRestClient accountsRestClient =
            new AccountsRestClient(gerritRestClient, EasyMock.createMock(AccountsParser.class));
    ...
    private GerritRestClient gerritRestClientExpectGet(String expectedUrl) throws Exception {
        ...
        EasyMock.expect(gerritRestClient.getRequest(expectedUrl)).andReturn(MOCK_JSON_ELEMENT).once();
    ...
    private GerritRestClient gerritRestClientExpectPut(String expectedUrl) throws Exception {
        GerritRestClient gerritRestClient = EasyMock.createMock(GerritRestClient.class);
        EasyMock.expect(gerritRestClient.putRequest(expectedUrl)).andReturn(MOCK_JSON_ELEMENT).once();
        EasyMock.replay(gerritRestClient);
        return gerritRestClient;
    }
    ...
    private GerritRestClient gerritRestClientExpectDelete(String expectedUrl) throws Exception {
        GerritRestClient gerritRestClient = EasyMock.createMock(GerritRestClient.class);
        EasyMock.expect(gerritRestClient.deleteRequest(expectedUrl)).andReturn(MOCK_JSON_ELEMENT).once();
        EasyMock.replay(gerritRestClient);
        return gerritRestClient;
    }
    ...
    private AccountsParser getAccountsParser() throws Exception {
        ...
        EasyMock.expect(accountsParser.parseAccountInfo(MOCK_JSON_ELEMENT)).andReturn(MOCK_ACCOUNT_INFO).once();
        EasyMock.replay(accountsParser);
        return accountsParser;
    }

    @Test
    public void testCreate() throws RestApiException {
        AccountInput input = new AccountInput();
        input.username = "john";
        Gson gson = new Gson();
        // Mock Account Parser's work
        AccountsParser accountsParser = EasyMock.createMock(AccountsParser.class);
        EasyMock.expect(accountsParser.getAccountInputJson(input)).andReturn(gson.toJson(input)).times(2);
        EasyMock.expect(accountsParser.parseAccountInfo(MOCK_JSON_ELEMENT)).andReturn(MOCK_ACCOUNT_INFO).once();
        EasyMock.replay(accountsParser);
        // Mock Gerrit Client's work
        GerritRestClient gerritRestClient = EasyMock.createMock(GerritRestClient.class);
        EasyMock.expect(gerritRestClient.putRequest("/accounts/john", accountsParser.getAccountInputJson(input)))
            .andReturn(MOCK_JSON_ELEMENT).once();
        EasyMock.replay(gerritRestClient);
        AccountsRestClient accountsRestClient = new AccountsRestClient(gerritRestClient, accountsParser);

        accountsRestClient.create(input);
